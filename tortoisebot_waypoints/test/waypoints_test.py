...
class TestWaypointAction(unittest.TestCase):
    def __init__(self, *args):
        ...
        goal_x = float(os.getenv('GOAL_X', 0.35))
        goal_y = float(os.getenv('GOAL_Y', 0.45))
    ...
    def test_end_position(self):
        ...
        self.assertTrue(
            self.result, "Action server did not complete the goal in time")
...
if __name__ == '__main__':
    rostest.rosrun('tortoisebot_waypoints',
                   'test_waypoint_action', TestWaypointAction)
